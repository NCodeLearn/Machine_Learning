...
*SCikil - learn and pandas
*Network Arditecturre
*Tensor Flow-2
*object deteciton
...
*Language models
*GAN's
*KARAS APT - Tonsorflow
*Productionize Tensorflow models,
*TF Transform - TF serving.
*Google Cloud API platforan - on Mobile Devices
*TF- Agents Library.
...
ing. It was created by David Cournapeau in 2007

• TensorFlow is a more complex library for distributed numerical computation. It
makes it possible to train and run very large neural networks efficiently TensorFlow (TF) was created at Google and supports
many of its large-scale Machine Learning applications
